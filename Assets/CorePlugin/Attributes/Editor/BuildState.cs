...
namespace CorePlugin.Attributes.Editor
{
    ...
    internal static class BuildState
    {
        ...
        {
            var errors = Enumerable.Empty<ErrorObjectPair>();
            var openScene = UnityEngine.SceneManagement.SceneManager.GetActiveScene().path;
            ...
            if (EditorBuildSettings.scenes.Length > 0)
                ...
                errors = UnityEngine.SceneManagement.SceneManager.GetActiveScene().GetRootGameObjects()
