...
namespace CorePlugin.Console
{
    ...
    public class MovableInsideScreen : MonoBehaviour, IDragHandler, IEndDragHandler, IBeginDragHandler
    {
        ...
        {
            if (!RectTransformUtility.ScreenPointToWorldPointInRectangle(drivenTransform, eventData.position, eventData.pressEventCamera, out var globalMousePos)) return;
